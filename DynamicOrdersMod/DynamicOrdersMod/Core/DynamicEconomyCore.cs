...
namespace DynamicOrdersMod.Core
{
    public class DynamicEconomyCore
    {
        ...
        /// <summary>
        /// Dead drop cleanup on contract failure is handled by ResolveDeadDropDeals at day-end
        /// (checks storage contents, marks undelivered deals as failed, sets cooldown).
        /// No real-time contract-failure hook needed — the day-end flow is authoritative.
        ///
